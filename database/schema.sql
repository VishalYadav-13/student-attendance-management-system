...
DROP TABLE IF EXISTS student_face_enrollments CASCADE;
DROP TABLE IF EXISTS student_face_templates CASCADE;
...
-- CompreFace Integration Table: Zero raw image biometric subject mappings
